export const localisedStrings = {
  ...
  askMeResponse: 'Have a question related to religious textbook, ask away by writing it down in the text bar',
  questionsDefaultString: "Please note that the message you're currently reading serves as a sample answer to your question. Thank you for your inquiry.",
