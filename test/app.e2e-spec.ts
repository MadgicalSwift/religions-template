...
it("should send an ask me message when the user clicks on the 'ask a question'or 'ask new question' button", async () => {
  ...
  jest
    ...
    jest
    .spyOn(messageService, 'sendAskmeMessage')
    ...
    expect(messageService.sendAskmeMessage).toHaveBeenCalledWith("1234567890", "English");
  ...
  it('should send a demo answer reponse when user asks a question', async () => {
    ...
    jest.spyOn(userService.userRepository, 'findOne').mockResolvedValue({
          ...
          mobileNumber: '1234567890',
          botID: '0238981860238953',
          button_response: 'Ask a question',
          language: 'English',
        });
        jest.spyOn(userService.userRepository, 'save').mockResolvedValue({
          id: '359a2e1e-ddb9-4cc5-8029-062bdf54bd66',
        ...
        jest
          .spyOn(messageService, 'sendQuestionRespone')
          .mockResolvedValueOnce(english);
    ...
    // Assertions
    expect(messageService.sendQuestionRespone).toHaveBeenCalledWith(body.text.body, "English","1234567890");
  ...
  //     expect(messageService.backToMainMenu).toHaveBeenCalledWith("1234567890", "English");
  //   });
  it('should send choose language buttons when the user clicks on a choose language', async () => {
    // Mock dependencies
    jest.spyOn(userService.userRepository, 'findOne').mockResolvedValue({
          id: '359a2e1e-ddb9-4cc5-8029-062bdf54bd66',
          mobileNumber: '1234567890',
    ...
    // Assertions
    expect(messageService.languageButtons).toHaveBeenCalledWith("1234567890", "English");
  });
